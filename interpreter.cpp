...
const QMap<QUuid, const QMetaObject *> Interpreter::m_metaObjects {
    ...
    {QUuid(0xce4f97be, 0x77b0, 0x4e19, 0x99, 0x56, 0xd4, 0x98, 0x33, 0xc9, 0x6c, 0x27), &Visualizer::staticMetaObject},
    ...
    {QUuid(0x00c074a0, 0xfea2, 0x49a0, 0xbe, 0x8d, 0xfa, 0xbb, 0xdb, 0x16, 0x16, 0x40), &Wac::staticMetaObject},
    {QUuid(0xcdcb785d, 0x81f2, 0x4253, 0x8f, 0x05, 0x61, 0xb8, 0x72, 0x28, 0x3c, 0xfa), &QueryList::staticMetaObject}};
...
const QMap<QString, QString> Interpreter::m_methodNames {
    ...
    {"integertotime", "integerToTime"},
    {"integertolongtime", "integerToLongTime"},
    {"getprivateint", "privateInt"},
    {"setprivateint", "setPrivateInt"},
    {"getprivatestring", "privateString"},
